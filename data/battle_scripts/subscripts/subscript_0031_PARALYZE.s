...
_000:
    ...
    CompareVarToValue OPCODE_FLAG_SET, BSCRIPT_VAR_FIELD_CONDITION, FIELD_CONDITION_WEATHER_NO_SUN, _016
...
_146:
    ...
    TrySynchronizeStatus _156
    CallFromVar BSCRIPT_VAR_TEMP_DATA

_156:
    TryCureStatusBerry BATTLER_CATEGORY_DEFENDER, _172
    CallFromVar BSCRIPT_VAR_TEMP_DATA
    End

_162:
    UpdateVar OPCODE_FLAG_OFF, BSCRIPT_VAR_BATTLE_STATUS, BATTLE_STATUS_SYNCRONIZE
    TryCureStatusBerry BATTLER_CATEGORY_SIDE_EFFECT_MON, _172
    CallFromVar BSCRIPT_VAR_TEMP_DATA
